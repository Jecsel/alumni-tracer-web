...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {label: 'Alumni', icon: 'pi pi-fw pi-user', routerLink: ['/account']},
            {label: 'Job Hiring', icon: 'pi pi-fw pi-shopping-bag', routerLink: ['/job-hiring']},
            {label: 'Event', icon: 'pi pi-fw pi-calendar', routerLink: ['/event']},
            {label: 'Report', icon: 'pi pi-fw pi-file-o', routerLink: ['/reports']},
            // {label: 'Home', icon: 'pi pi-fw pi-home', routerLink: ['/homepage']},
            {label: 'Logout', icon: 'pi pi-fw pi-external-link', routerLink: ['/login']},
            {
